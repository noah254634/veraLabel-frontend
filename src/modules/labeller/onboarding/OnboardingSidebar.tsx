    ...
    <aside className="w-full md:w-72 lg:w-80 bg-[#050505]/80 backdrop-blur-2xl p-6 md:p-10 flex flex-row md:flex-col justify-between border-b md:border-b-0 md:border-r border-zinc-900 sticky top-0 z-10">
      <div className="flex flex-row md:flex-col items-center md:items-start gap-6 md:gap-12 w-full">
        ...
        <button
          ...
          className="md:hidden ml-auto inline-flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest text-zinc-400 hover:text-red-300 hover:bg-red-500/10 transition-colors"
        >
          <LogOut size={14} />
          Sign Out
        </button>
      ...
      <div className="hidden md:block pt-6 border-t border-zinc-900">
        ...
        <button
          type="button"
          onClick={handleLogout}
          className="mt-5 w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-xs font-black uppercase tracking-widest text-zinc-400 hover:text-red-300 hover:bg-red-500/10 transition-colors"
        >
          <LogOut size={14} />
          Sign Out
        </button>
