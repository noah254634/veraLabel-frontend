    ...
    <div className="text-center p-6 md:p-12 space-y-6 relative overflow-y-auto h-full flex flex-col scrollbar-thin scrollbar-thumb-indigo-600/30 hover:scrollbar-thumb-indigo-600/50 scrollbar-track-white/5">
      ...
      <div className="relative z-10 space-y-8 m-auto">
        ...
        <div className="relative w-24 h-24 mx-auto">
          ...
          <div className="relative w-24 h-24 bg-[#1a1a1e] border border-zinc-900 rounded-[32px] flex items-center justify-center shadow-2xl animate-in zoom-in duration-700">
        ...
        <div className="flex flex-col gap-3 pt-6 max-w-xs mx-auto">
          <div className="p-5 bg-[#1a1a1e] border border-zinc-900 rounded-3xl shadow-inner relative overflow-hidden group">
