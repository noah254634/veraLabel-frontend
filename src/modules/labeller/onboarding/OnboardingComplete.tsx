import { ArrowRight, ShieldCheck, Globe, Fingerprint } from "lucide-react";
...
export const OnboardingComplete = () => {
  ...
  return (
    <div className="text-center p-6 md:p-12 space-y-6 relative overflow-y-auto h-full flex flex-col scrollbar-thin scrollbar-thumb-indigo-600/30 hover:scrollbar-thumb-indigo-600/50 scrollbar-track-white/5">
      ...
      <div className="relative z-10 space-y-8 m-auto">
        <div className="relative w-24 h-24 mx-auto">
          ...
          <div className="relative w-24 h-24 bg-[#0a0a0c] border border-zinc-900 rounded-[32px] flex items-center justify-center shadow-2xl animate-in zoom-in duration-700">
            <Fingerprint className="text-indigo-500/80" size={40} />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 pt-6 max-w-xs mx-auto w-full">
          <div className="p-6 bg-[#0a0a0c] border border-zinc-900 rounded-[32px] shadow-2xl relative overflow-hidden group">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <Globe size={12} className="text-indigo-500 animate-pulse" />
            ...
            <div className="text-left mb-6 space-y-1">
              <p className="text-[10px] text-zinc-600 uppercase font-bold tracking-widest">Designation</p>
            ...
            <button
              ...
              className="w-full py-4 px-4 bg-indigo-600 hover:bg-indigo-500 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] text-white transition-all flex items-center justify-center gap-3 group/btn shadow-lg shadow-indigo-900/20"
            >
      ...
      <div className="absolute bottom-8 left-12 right-12 flex items-center gap-4">
        ...
        <span className="text-[8px] text-indigo-500/50 font-black tracking-widest uppercase">
          Ready
        </span>
      </div>
    </div>
